package weijiangtao.bwie.com.weijiangtao20170410.view;
...
import weijiangtao.bwie.com.weijiangtao20170410.R;
 ...
 *
 */
public class Sayview extends View {
    /**
     * 画笔对象的引用 
     */
    private Paint paint;
    ...
    public Sayview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Sayview(Context context, AttributeSet attrs, int defStyle) {
